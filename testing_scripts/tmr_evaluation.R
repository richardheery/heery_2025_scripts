...
cpgea_normal_tmrs$ID = gsub("_.*", "", cpgea_normal_tmrs$name)
...
system.time({cpgea_normal_tmrs_correlations_normal_samples = calculateRegionMethylationTranscriptCors(
  genomic_regions = cpgea_normal_tmrs, genomic_region_names = cpgea_normal_tmrs$name, samples_subset = common_cpgea_normal_samples,
...
system.time({tmr_coverage = summarizeRegionMethylation(meth_rse = cpgea_meth_rse, assay = 2, genomic_regions = cpgea_normal_tmrs, genomic_region_names = cpgea_normal_tmrs$name, BPPARAM = bpparam)})
system.time({tmr_meth = summarizeRegionMethylation(meth_rse = cpgea_meth_rse, assay = 1, genomic_regions = cpgea_normal_tmrs, genomic_region_names = cpgea_normal_tmrs$name, BPPARAM = bpparam)})
