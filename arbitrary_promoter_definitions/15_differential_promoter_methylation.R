...
ggsave(plot = hypermethylated_hypomethylated_intersections_plot, 
  filename = "../figures//supp_figure6.pdf", height = 9, width = 9)
  
### Make upset diagrams for hypermethylated and hypomethylated promoters

pdf(file = "../figures/supp_figure7_top.pdf", width = 25, height = 14, bg = "white")
...
pdf(file = "../figures/supp_figure7_bottom.pdf", width = 25, height = 14, bg = "white")
